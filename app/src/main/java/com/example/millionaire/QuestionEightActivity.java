        ...
        buttonContinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(radioButton.getText().equals(correctAnswer)){
                    Toast.makeText(getApplicationContext(),"Correct, you earned $16000!", Toast.LENGTH_SHORT).show();
                    ...
                    startActivity(new Intent(QuestionEightActivity.this, EndActivity.class));
                }
            }
        });
    }
